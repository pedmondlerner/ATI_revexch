...
% This code is only different from "mainThP.m" in that it initiates the
% state vector with "priorstatevecsmallerror.m", which forces the errors in
% the radionuclide and particle data to be very small compared to the
% errors in the prior estiamtes of the rate constants.
...
global Th234davg Th234pavg U238avg Th230davg Th230pavg U234avg Th228davg Th228pavg Ra228avg Pavg...
    ...
    cmbTh Pdepth Ddepth Thdq Thdq2 dTh230 dTh228 dTh234 x0 C0 sumTh234d sumTh234p sumTh230d sumTh230p sumTh228d sumTh228p sumP
...
Th230p=input('Please input particualte Th230 for x0 \n');
