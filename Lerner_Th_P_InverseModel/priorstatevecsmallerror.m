% This function constructs the prior estimate of the state vector, x0, and its error covariance matrix, C0. The
...
% rate constant. This routine also reduces the errors in the original
% data, and is used with "mainThPsmallerror.m". 
...
% The only difference from "priorstatevecsmallerror.m" is that this routine
% forces the errors in the radionuclide and particle data to be very small
% by reducing the variance in the data by three orders of magnitude.
C0(1:end-(4*Ddepth),1:end-(4*Ddepth))=C0(1:end-(4*Ddepth),1:end-(4*Ddepth))./1000;