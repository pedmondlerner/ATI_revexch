% [sumTh234d,sumTh234p,sumTh230d,sumTh230p,sumTh228d,sumTh228p]=modelnorm(x0);
...
function [sumTh234d,sumTh234p,sumTh230d,sumTh230p,sumTh228d,sumTh228p,sumP]=modelnorm(x0);

global Th234davg Th234pavg U238avg Th230davg Th230pavg U234avg Th228davg Th228pavg Ra228avg Pavg cmbTh Pdepth Ddepth Thdq Thdq2 dTh234 dTh230 dTh228 wavg Bremavg k1avg kdesavg Pdo
x=x0;
...
% of the terms in the appropriate model equations.
if cmbTh==1
for j=1:Ddepth
